...
export const config = {
  productName: 'NITINDYT LAUNCHER+',
  appId: 'nitindyt-launcher-plus',
  directories: {
    output: 'build/output',
  ...
  protocols: {
    ...
    schemes: ['nitindyt-launcher-plus'],
  },
  ...
  appx: {
    displayName: 'NITINDYT LAUNCHER+',
    applicationId: 'nitindyt-launcher-plus',
    identityName: 'nitindyt-launcher-plus',
